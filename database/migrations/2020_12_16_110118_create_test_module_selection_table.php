...
class CreateTestModuleSelectionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('test_module_selection', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('test_module_selection');
    }
}
