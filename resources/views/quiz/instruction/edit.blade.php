...
@section('title', 'Instruction Master')
@section('content_header')
    <div class="row">             
        <div class="col-sm-6">
        <h1 class="m-0 text-dark">Instruction Master</h1>
        </div>
     </div>
@endsection
@section('content')
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Update Instruction</h3>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('quiz.instruction.update', ['instruction' => $data->id]) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="select2 select2-hidden-accessible assigned_to" data-placeholder="Select Content type" style="width: 100%;" name="assigned_to" id="assigned_to">
                                       <option value="">Select</option>
                                       @foreach(config('constants.atq') as $key => $c_type)
                                       <option value="{{ $key }}" @if($data->assigned_to == $key) selected="selected" @endif>{{ $c_type }}</option>
                                       @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="tinymce-editor1" name="description">{{ $data->description }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a href="{{ route('quiz.instruction.index') }}" class="btn btn-secondary float-right" style="margin-right: 5px;">Back</a>
                            </div>
                        </div>
