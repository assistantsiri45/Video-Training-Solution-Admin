...
<section class="content">
   ...
   <div class="card card-default">
      <div class="card-header">
         <h3 class="card-title">Create Instruction</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
         <form class="form-horizontal" action="{{ route('quiz.instruction.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
               <div class="col-md-4">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select class="select2 select2-hidden-accessible assigned_to" data-placeholder="Select Content type" style="width: 100%;"  name="assigned_to" id="assigned_to">
                        ...
                        <option {{ (old('assigned_to') == $key ? "selected":"") }}  value="{{ $key }}">{{ $c_type }}</option>
                        @endforeach
                     </select>
                  </div>
               </div>
