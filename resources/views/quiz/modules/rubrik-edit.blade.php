    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('quiz.module.auto-update', ['ID' => $module->id]) }}" method="post">
                        @csrf
                        ...
                        <div class="card card-body" id="refresh-table">
                            @include('quiz.modules.rubrik-table')
                        </div>
                        <div class="row">
                            <div class="col-12">
...
// alert(1);
                ...
                total = parseInt(total) + parseInt(selection.val()) - parseInt(old_data);
