...
<section class="content">
   <div class="container-fluid">
      <div class="card card-default">
         ...
         <div class="card-body">
            <form class="form-horizontal" action="{{ route('backend.subject.update', ['subject' => $data->id]) }}" method="post" enctype="multipart/form-data">
               @csrf
               @method('PUT')
               <div class="row">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        <label>Colour</label>
                        <input type="text" class="form-control" name="color" value="{{$data->colour}}" id="colour">
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        <label> &nbsp;</label>
                        <input type="text" readonly class="form-control"  value="{{$data->icon}}">
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-12">
                     ...
                     <a href="{{ route('backend.subject.index') }}" class="btn btn-secondary float-right" style="margin-right: 5px;">Back</a>
                  </div>
               </div>
            </form>
         </div>
