...
<table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
            ...
            <table width="70" align="center" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
                    <td height="70" style="padding: 0 20px 20px 0;">
                        <a href="{{ $attributes['web'] }}"><img class="fix" src="{{ $message->embed($attributes['logo']) }}" width="150" border="0" alt=""></a>
                    </td>
                </tr>
                </tbody></table>
        </td>
    ...
    <tr>
        <td class="innerpadding borderbottom" style="padding-top: 0px;">
            <p>Dear Admin,</p>
            <p>Technical issue <strong>{{ $attributes['query']}}</strong> raised by {{ $attributes['name'] }} has been addressed successfully.</p>
            <p>Regards,<br>Team Datavoice</p>
        </td>
    </tr>
    <tr>
