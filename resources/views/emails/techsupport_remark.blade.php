...
<body>
    <div class="container" style="max-width:750px !important;">
        ...
        <div class="content">
            <h3>Dear {{ $attributes['name'] }},</h3>
            <h3 style="margin-bottom: 10px;">Your query <strong>{{ $attributes['query'] }}</strong> has been resolved.</h3>

            <h3>For any further queries kindly contact us on 8070 400 900 or write to us on helpdesk@jkshahclasses.com</h3><br>
            
            <h3>Regards,<br>Team J. K. Shah</h3>
