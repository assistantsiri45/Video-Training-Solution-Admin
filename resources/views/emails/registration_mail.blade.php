...
<table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        <td class="innerpadding borderbottom" style="padding-top: 0px;">
            ...
            <br />
            <br />
            Thank you for being a part of JKSHAH ONLINE. Your JKSHAH Account credentials are given below. Do not share with others.
            <br />
            <br />
            ...
            <br />
            <br />
            <a href="{{ $attributes['web'] }}" style="background-color: #f58457; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px;">Login Now</a>
            <br />
            <br />
        </td>
    </tr>
