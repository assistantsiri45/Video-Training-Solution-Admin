    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info btn-refresh-folder" id="btn-refresh-folder">Refresh</button>
                <button type="button" class="btn btn-primary btn-choose-folder" id="btn-choose-folder" disabled>Choose Folder</button>
            </div>
        </div>
    </div>
</div>
...
@push('js')
    <script id="choose-folder-modal">
        $(function () {
            ...
            $modal.find('.btn-refresh-folder').click(function (e) {
                e.preventDefault();
