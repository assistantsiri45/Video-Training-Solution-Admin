    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card card-primary">
                <form role="form" id="create" method="POST" action="{{ route('blogs.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" placeholder="Slug" value="{{ old('title') }}" autocomplete="off">
                                    @error('slug')
...
{{--                            </div>--}}
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('author') is-invalid @enderror" id="author" name="author" placeholder="Author" value="{{ old('author') }}" autocomplete="off">
                                    @error('author')
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="upload">Image (Size: 720 X 480 PX)</label>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="upload" name="file" @error('file') is-invalid @enderror required data-toggle="modal" data-target="#exampleModalCenter">
