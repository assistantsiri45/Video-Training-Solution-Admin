...
@section('title', 'Update Chapter Package')
        ...
        <div class="col">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update Chapter Package</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-8">
            <div class="card card-primary">
                <form role="form" id="create" method="POST" action="{{ route('packages.chapter.update', $package->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <x-inputs.course id="course_id" class="{{ $errors->has('course_id') ? ' is-invalid' : '' }}" style="width: 100%;">
                                        @if(!empty(old('course_id', $package->course_id)))
                                            <option value="{{ old('course_id', $package->course_id) }}" selected>{{ old('course_id_text', optional($package->course)->name) }}</option>
                                        @endif
                                    </x-inputs.course>
                                ...
                                <div class="form-group">
                                    ...
                                    <x-inputs.level id="level_id" related="#course_id" style="width: 100%;">
                                        @if(!empty(old('level_id', $package->level_id)))
                                            <option value="{{ old('level_id', $package->level_id) }}" selected>{{ old('level_id_text', optional($package->level)->name) }}</option>
                                        @endif
                                    </x-inputs.level>
                                ...
                                <div class="form-group">
                                    ...
                                    <x-inputs.chapter id="chapter_id" related="#subject" style="width: 100%;">
                                        @if(!empty(old('chapter_id', $package->chapter_id)))
                                            <option value="{{ old('chapter_id', $package->chapter_id) }}" selected>{{ old('chapter_id_text', optional($package->chapter)->name) }}</option>
                                        @endif
                                    </x-inputs.chapter>
                                ...
                                <div class="form-group">
                                    ...
                                    <x-inputs.language id="language_id" related="#language_id" style="width: 100%;">
                                        @if(!empty(old('language_id', $package->language_id)))
                                            <option value="{{ old('language_id', $package->language_id) }}" selected>{{ old('language_id_text', optional($package->language)->name) }}</option>
                                        @endif
                                    </x-inputs.language>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        @else
                                            <input id="freemium_content" name="freemium_content" type="number" min="0" class="form-control @error('freemium_content') is-invalid @enderror" value="{{ old('freemium_content', 0) }}">
                                        @endif
...
{!! $html->scripts() !!}
    <script>
        ...
        var level_id='{{$package->level_id}}';
        var subject_id='{{$package->subject_id}}';
