...
@section('content_header')
    <div class="row">
        ...
        <div class="col">
            <form method="POST" id="form_pkg" action="{{ url("packages/$package->id/chapter-packages") }}">
                @csrf
                <input type="hidden" id="chapter-package-ids" name="chapter_package_ids">
...
@section('js')
    ...
    <script>
            ...
            $('#chapter-package-ids').val(JSON.stringify(checkedPackages));
