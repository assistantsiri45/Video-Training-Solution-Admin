...
@section('title', 'Update Subject Package')
        ...
        <div class="col">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update Subject Package</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-8">
            <div class="card card-primary">
                <form role="form" id="create" method="POST" action="{{ route('packages.subject.update', $package->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
            ...
            $.ajax({
                ...
                $('#select_subject').empty();
                   if(response.length>0){
                        $('#select_subject').append('<option disabled selected>  Choose Subject </option>');
...
$('#btn-clear').click(function() {
                ...
                $('#select_subject').val('').trigger('change');
