...
@section('content_header')
    <div class="row">
        ...
        <div class="col">
            ...
            <a href="{{ route('packages.subject.edit', $package->id) }}" class="btn btn-sm btn-primary float-right mr-3"><i class="fas fa-edit"></i></a>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <div class="row">
                            <div class="col text-left">
                                <h3>Subject Level Packages</h3>
                            </div>
                            <div class="col text-right">
                                <a href="{{url("packages/$package->id/chapter-packages/order")}}" type="button" class="btn btn-success mr-2">Change Order</a>
                                <a href="{{url("packages/$package->id/chapter-packages")}}" type="button" class="btn btn-warning">Add/Edit</a>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                            {!! $subjectPackages->table(['id' => 'subject-level-packages'], true) !!}
                    </div>
                </div>
            </div>
        </div>
...
@section('js')
    ...
    <script>
        ...
        $(function() {
            ...
            var subject_package_count = {{$subject_package_count}};
            ...
            $('#modal-publish-button').click(function () {
                ...
                if(subject_package_count>0 || is_prebook) {
            ...
            let tablePackages = $('#subject-level-packages').DataTable();
