...
@section('title', 'Create Subject Package')

@section('content_header')
    <h1 class="m-0 text-dark">Create Subject Package</h1>
@stop
    ...
    <div class="row">
        <div class="col-sm-8">
            <div class="card card-primary">
                <form role="form" id="create" method="POST" action="{{ route('packages.subject.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <!-- <input id="expire_at" name="expire_at" type="date" class="form-control @error('expire_at') is-invalid @enderror" value="{{ old('expire_at') }}">
                                    @error('expire_at')
