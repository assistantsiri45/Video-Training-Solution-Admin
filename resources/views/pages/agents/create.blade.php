...
@section('content_header')
    <h1 class="m-0 text-dark">Create Associates</h1>
@stop
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card card-primary">
                <form role="form" id="create" method="POST" action="{{ route('agents.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="commission" name="commission" class="form-control @error('commission') is-invalid @enderror" value="{{ old('commission') }}" placeholder="Commission">
                                    @error('commission')
...
{{--                                    <input type="text" id="repeat-purchase-by-agent-commission" name="repeat_purchase_by_agent_commission" class="form-control @error('repeat_purchase_by_agent_commission') is-invalid @enderror" value="{{ old('repeat_purchase_by_agent_commission') }}" placeholder="Repeat purchase by agent commission">--}}
...
{{--                                    <input type="text" id="repeat-purchase-by-student-commission" name="repeat_purchase_by_student_commission" class="form-control @error('repeat_purchase_by_student_commission') is-invalid @enderror" value="{{ old('repeat_purchase_by_student_commission') }}" placeholder="Repeat purchase by student commission">--}}
...
{{--                                    <input type="text" id="repeat-purchase-by-other-agent-commission" name="repeat_purchase_by_other_agent_commission" class="form-control @error('repeat_purchase_by_other_agent_commission') is-invalid @enderror" value="{{ old('repeat_purchase_by_other_agent_commission') }}" placeholder="Repeat purchase by other agent commission">--}}
