...
class MailOrderExport implements FromQuery, WithMapping, WithHeadings ,WithEvents
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->setCellValue('X'. ($last_row+2),'TOTAL');
                $event->sheet->setCellValue('Y'. ($last_row+2), '=SUM(Y2:Y'.$last_row.')');
