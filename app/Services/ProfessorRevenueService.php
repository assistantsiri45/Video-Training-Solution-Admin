...
class ProfessorRevenueService
{
    public function store($attributes = [])
    {
        ...
        $netAmount = round( $attributes['net_amount']/1.18, 2);

        $professorRevenues = $this->getProfessorRevenues($package, $netAmount);
        ...
        foreach ($professorRevenues as $revenue) {
            ...
            $professorRevenue->package_total = $netAmount;
            ...
            $professorRevenue->order_id = $attributes['order_id'];
            $professorRevenue->order_item_id = $attributes['order_item_id'];
    ...
    public function storeprofessorrevenue($attributes = [])
    {
        $package = $this->getPackage($attributes['package_id']);
