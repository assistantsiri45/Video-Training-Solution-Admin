...
class StudentCourier extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->to($this->attributes->orderItem->order->student->email)
        //    ->bcc('jeswill@datavoice.co.in')
            ->subject('JKSHAH ONLINE - ORDER IS SHIPPED')
            ->view('emails.student_courier')
